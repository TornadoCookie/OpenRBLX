...
const BrickColor brickColors[] = {
    ...
    {"Pastel Blue", (Color3){0.502, 0.734, 0.859}, 11},
    {"Bright red", (Color3){0.769, 0.157, 0.110}, 21},
    {"Bright blue", (Color3){0.051, 0.412, 0.675}, 23},
    {"Bright yellow", (Color3){0.961, 0.804, 0.189}, 24},
    {"Black", (Color3){0.106, 0.165, 0.208}, 26},
    {"Dark grey", (Color3){0.428, 0.432, 0.424}, 27},
    ...
    {"Medium red", (Color3){0.855, 0.526, 0.479}, 101},
    {"Medium blue", (Color3){0.432, 0.6, 0.793}, 102},
    {"Bright violet", (Color3){0.420, 0.197, 0.487}, 104},
    {"Br. yellowish orange", (Color3){0.887, 0.608, 0.251}, 105},
    {"Bright orange", (Color3){0.855, 0.522, 0.255}, 106},
    {"Bright bluish green", (Color3){0.000, 0.561, 0.612}, 107},
    {"Br. yellowish green", (Color3){0.644, 0.742, 0.279}, 119},
    {"Light orange", (Color3){0.918, 0.722, 0.573}, 125},
    {"Neon orange", (Color3){0.836, 0.451, 0.240}, 133},
